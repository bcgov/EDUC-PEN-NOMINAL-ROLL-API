...
public class EventTaskScheduler {
  ...
  @Scheduled(fixedRateString = "${scheduled.jobs.process.loaded.nom.roll.students.fixedRate}")
  @SchedulerLock(name = "PROCESS_LOADED_STUDENTS", lockAtLeastFor = "1500ms", lockAtMostFor = "1600ms")
