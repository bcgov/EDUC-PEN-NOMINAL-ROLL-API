...
@EnableRetry
@EnableJpaRepositories(basePackages = "ca.bc.gov.educ.pen.nominalroll.api.repository.v1")
public class NominalRollApiApplication {
  /**
  ...
  public static void main(final String[] args) {
    SpringApplication.run(NominalRollApiApplication.class, args);
  }
  ...
  public LockProvider lockProvider(@Autowired final JdbcTemplate jdbcTemplate, @Autowired final PlatformTransactionManager transactionManager) {
    return new JdbcTemplateLockProvider(jdbcTemplate, transactionManager, "NOMINAL_ROLL_SHEDLOCK");
  }
